...
const HeroSection = () => {
  return (
    <div className="hidden lg:flex lg:w-5/12 xl:w-1/2 relative flex-col justify-center p-16 bg-gradient-to-br from-[#4F46E5] via-[#6366F1] to-[#818CF8] overflow-hidden">
  ...
  return (
    <header className="flex items-center justify-between px-8 py-6 border-b border-gray-200 bg-white">
      <div className="lg:hidden flex items-center gap-2">
        <div className="size-6 text-[#4F46E5]">
      ...
      <div className="flex-1 flex justify-end items-center gap-4">
        ...
        <a
          className="text-sm font-semibold text-[#4F46E5] hover:text-[#6366F1] transition-colors"
          href="#"
        >
          Log in
        </a>
  ...
  return (
    <div className="flex flex-col gap-2 mb-10">
      <div className="flex justify-between items-center">
        ...
        <p className="text-[#4F46E5] text-sm font-bold">50%</p>
      </div>
...
const CareerStatusCard = ({
  ...
  return (
    <div
      className={`relative cursor-pointer group flex flex-col p-6 border-2 ${isSelected ? "border-[#4F46E5] bg-[#EEF2FF]" : "border-gray-200 hover:border-[#4F46E5]/50"} rounded-xl transition-all hover:bg-[#EEF2FF]/50`}
      onClick={onClick}
    >
      <div className="flex items-start justify-between mb-4">
        <div
          className={`p-2 ${isSelected ? "bg-[#4F46E5]" : "bg-gray-100 group-hover:bg-[#4F46E5]/10"} rounded-lg transition-colors`}
        >
          <Icon
            className={`text-2xl ${isSelected ? "text-white" : "text-gray-700 group-hover:text-[#4F46E5]"}`}
          />
        </div>
        <div
          className={`h-5 w-5 rounded-full border-2 ${isSelected ? "border-[#4F46E5]" : "border-gray-400"} flex items-center justify-center`}
        >
          {isSelected && (
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 bg-white focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 outline-none transition-all text-gray-900"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                className="w-full pl-10 pr-10 py-3 rounded-lg border border-gray-300 bg-white focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 outline-none transition-all text-gray-900"
                placeholder="••••••••"
          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              <div className="px-3 py-3 bg-[#EEF2FF] border border-r-0 border-gray-300 rounded-l-lg text-sm text-[#4F46E5] font-medium">
                +1
              </div>
              <div className="relative flex-1">
                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 size-5" />
                <input
                  className="w-full pl-10 pr-4 py-3 rounded-r-lg border border-gray-300 bg-white focus:border-[#4F46E5] focus:ring-2 focus:ring-[#4F46E5]/20 outline-none transition-all text-gray-900"
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <span className="px-3 py-1 bg-[#EEF2FF] text-[#4F46E5] rounded-full text-xs font-medium">
              Technology
            </span>
  ...
  return (
    <footer className="px-8 py-6 border-t border-gray-200 bg-[#FDFCFB]">
      <div className="flex flex-wrap justify-center gap-8 text-xs font-medium text-gray-700 uppercase tracking-widest">
        <a
          className="hover:text-[#4F46E5] transition-colors flex items-center gap-1"
          href="#"
        >
    ...
    <main className="flex-1 overflow-y-auto no-scrollbar py-12 px-8 sm:px-12 md:px-24 bg-[#FDFCFB]">
      <div className="mx-auto max-w-200">
        <div className="mb-10">
          ...
          <p className="text-[#4F46E5] text-base font-medium">
        ...
        <form className="space-y-12">
          ...
          <div className="pt-6 space-y-4">
            <button
              ...
              className="w-full py-4 bg-[#4F46E5] text-white font-bold rounded-xl hover:bg-[#6366F1] shadow-lg shadow-[#4F46E5]/30 transition-all flex items-center justify-center gap-2"
              type="button"
            >
            ...
            <p className="text-center text-xs text-gray-700 leading-relaxed px-6">
              ...
              <a
                className="underline hover:text-[#4F46E5] transition-colors text-gray-900 font-medium"
                href="#"
              >
                Terms of Service
              </a>{" "}
